#!/usr/bin/env python3
"""
ONNX Runtime inference benchmark runner.

Provides CLI and programmatic interface for benchmarking ONNX models
on Raspberry Pi 5.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="ONNX Runtime inference benchmark",
